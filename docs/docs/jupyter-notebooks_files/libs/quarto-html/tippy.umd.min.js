!((e, t) => {
	...
	function v(e) {
		return ["Element", "Fragment"].some((t) => o(e, t));
	}
	function m(e) {
	...
	function j(e, t) {
		var n = Object.assign(
			...
			t.ignoreAttributes
				...
				: ((e, t) =>
						(t
							? Object.keys(P(Object.assign({}, R, { plugins: t })))
							: k
						).reduce((t, n) => {
	...
	function S(e) {
		...
		return {
			box: t,
			content: n.find((e) => e.classList.contains("tippy-content")),
			arrow: n.find(
				(e) =>
					e.classList.contains("tippy-arrow") ||
					e.classList.contains("tippy-svg-arrow"),
			),
			backdrop: n.find((e) => e.classList.contains("tippy-backdrop")),
		};
	}
	function N(e) {
		var t = d(),
	...
	function _(o, s) {
		var v,
			...
			X = B++,
			Y = (k = M.plugins).filter((e, t) => k.indexOf(e) === t),
			$ = {
				id: X,
				reference: o,
				popper: d(),
		...
		function se() {
			...
			if (e.content) {
				var t = "aria-" + e.content,
					n = z.id;
				u($.props.triggerTarget || o).forEach((e) => {
		...
		function ce() {
			ne().removeEventListener("mousemove", W), (H = H.filter((e) => e !== W));
		}
		function pe(e) {
			if (!x.isTouch || (!N && "mousedown" !== e.type)) {
				var t = (e.composedPath && e.composedPath()[0]) || e.target;
				if (!$.props.interactive || !O(z, t)) {
					if (u($.props.triggerTarget || o).some((e) => O(e, t))) {
						if (x.isTouch) return;
		...
		function ge(e, t, n) {
			void 0 === n && (n = !1),
				u($.props.triggerTarget || o).forEach((r) => {
		...
		function he() {
			...
			Z() &&
				...
				((e = $.props.trigger), e.split(/\s+/).filter(Boolean)).forEach((e) => {
					if ("manual" !== e)
						switch ((ge(e, ye), e)) {
							case "mouseenter":
								ge("mouseleave", Ee);
		...
		function ye(e) {
			...
			if ($.state.isEnabled && !xe(e) && !I) {
				...
				(C = e),
					(L = e.currentTarget),
					ue(),
					!$.state.isVisible && m(e) && H.forEach((t) => t(e)),
					"click" === e.type &&
				...
				p = [
					...
					{ name: "computeStyles", options: { adaptive: !s } },
					{
						...
						fn: (e) => {
							...
							if (ee()) {
								var n = re().box;
								["placement", "reference-hidden", "escaped"].forEach((e) => {
									"placement" === e
	...
	var J = {
		...
		fn: (e) => {
			...
			function d() {
				0 ===
					(q = q.filter((t) => t.instance !== e)).filter((e) => e.doc === n)
						.length &&
					((e) => {
	...
	return (
		...
		(F.createSingleton = (e, t) => {
			...
			function l() {
				a = o
					.map((e) => u(e.props.triggerTarget || e.reference))
					.reduce((e, t) => e.concat(t), []);
			}
			function v() {
				i = o.map((e) => e.reference);
			}
			function m(e) {
				o.forEach((t) => {
			...
			return (
				u(l).forEach((e) => {
					...
					(e.destroy = (e) => {
						...
						(e.enable = () => {
							a(), o.forEach((e) => e.enable()), (i = !1);
						}),
						(e.disable = () => {
							s(), o.forEach((e) => e.disable()), (i = !0);
						}),
						((e) => {
							var n = e.reference;
							v(n, "touchstart", d, t),
