	...
	() => (
		(n = {
			686: (t, e, n) => {
				...
				function y(t, e) {
					return (y =
						Object.setPrototypeOf || ((t, e) => ((t.__proto__ = e), t)))(t, e);
				}
				function h(n) {
					var o = (() => {
					...
					return (
						...
						(e = [
							...
							},
							{
								key: "listenClick",
								value: function (t) {
									this.listener = u()(t, "click", (t) => this.onClick(t));
								},
							},
							{
								key: "onClick",
							...
							{ key: "defaultAction", value: (t) => m("action", t) },
							{
								key: "defaultTarget",
								value: (t) => {
									t = m("target", t);
							...
							{ key: "defaultText", value: (t) => m("text", t) },
							{
								key: "destroy",
								value: function () {
