...
def configure_github_repo(
    ...
    try:
        ...
        if not repo_name.replace("-", "").replace("_", "").isalnum():
            raise ValueError("Invalid repository name. Use only letters, numbers, underscores, and hyphens.")
        ...
        if not no_github:
            ...
            if is_public:
                ...
                print("Warning: Branch protections can only be set for public repositories "
